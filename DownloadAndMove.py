...
from_dir = "C:/Users/shaur/Downloads/sample"              # Add the path of you "Downloads" folder.
to_dir = "C:/Users/shaur/OneDrive/Desktop/Downloaded_files" #Create "Document_Files" folder in your Desktop and update the path accordingly.
